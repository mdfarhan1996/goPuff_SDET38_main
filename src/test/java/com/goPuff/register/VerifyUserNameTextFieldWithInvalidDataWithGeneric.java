package com.goPuff.register;
		...
		public class VerifyUserNameTextFieldWithInvalidDataWithGeneric {
			...
			public static void main(String[] args) throws Throwable {
				...
				String LASTNAME = elib.getExcelData("Sheet1",1,2)+intRanNum;
				String FIRSTNAME = elib.getExcelData("Sheet1",1,3)+intRanNum;
				String  EMAIL = elib.getExcelData("Sheet1",1,4)+intRanNum;
				String PASSWORD = elib.getExcelData("Sheet1",1,5)+intRanNum;
				String  CPASSWORD = elib.getExcelData("Sheet1",1,6)+intRanNum;
				String  PHONE = elib.getExcelData("Sheet1",1,7)+intRanNum;
				String  ADDRESS = elib.getExcelData("Sheet1",1,8)+intRanNum;
