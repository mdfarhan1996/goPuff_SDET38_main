...
public class VerifyDeleteButtonInCart {
...
String BROW = prop.getProperty("BROWSER");//step 2:read the test data from excelsheet
...
//		         
			...
			//step:5 navigate to restaurants and place an order				
				driver.findElement(By.xpath("//a[text()='Restaurants ']")).click();
				driver.findElement(By.xpath("//a[text()='Eataly']/ancestor::div/following-sibling::div/descendant::a[text()='View Menu']")).click();
				
				driver.findElement(By.xpath("//a[text()='Pink Spaghetti Gamberoni']/ancestor::div[@class='food-item']/descendant::input[@type='submit']")).click();
				driver.findElement(By.xpath("//a[text()='Cheesy Mashed Potato']/ancestor::div[@class='food-item']/descendant::input[@type='submit']")).click();
				driver.findElement(By.xpath("//i[@class='fa fa-trash pull-right']")).click();
